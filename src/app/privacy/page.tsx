              ...
              <div className="legal-body">
                <Section title="1. Information we collect">
                  ...
                  <p>
                    ...
                    connected project-management tools. We only access data that
                    your workspace administrators authorize through those
                    integrations.
                  </p>
                  <p>
                    <strong>Automatically collected information.</strong> When
                    you use the Site or Service, we may collect device and usage
                    information such as IP address, browser type, pages viewed,
                    referring URLs, and approximate location derived from IP
                    address. We use Vercel Analytics on the Site to understand
                ...
                <Section title="3. How we share information">
                  ...
                  <ul>
                    <li>
                      ...
                      analytics, payment, email, and AI infrastructure partners
                      that process data on our behalf under contractual
                      safeguards;
                    </li>
                    <li>
                      <strong>Connected integrations</strong> you authorize,
                      such as Slack, Linear, or Jira, according to the
                      permissions you grant;
                    </li>
                    <li>
                      <strong>Legal and safety recipients</strong> when required
                      by law or to protect rights, safety, and security; and
                    </li>
                    <li>
                      <strong>Business transfers</strong> in connection with a
                      merger, acquisition, or asset sale, subject to this Privacy
                      Policy.
                    </li>
                  </ul>
                </Section>
                ...
                <Section title="7. Your choices and rights">
                  ...
                  <p>
                    ...
                    <a href="mailto:privacy@ceptly.ai">privacy@ceptly.ai</a>. We
                ...
                <Section title="11. Contact us">
                  ...
                  <p>
                    ...
                    <br />
                    Email:{" "}
                    <a href="mailto:privacy@ceptly.ai">privacy@ceptly.ai</a>
                  </p>
                </Section>
              </div>
            </div>
