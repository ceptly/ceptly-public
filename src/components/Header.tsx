      ...
      >
        ...
        >
          ...
          <nav className="flex flex-1 flex-col px-2 py-4">
            {NAV_LINKS.map(({ href, label }) => (
              <Link
                ...
                href={href}
                onClick={closeMenu}
                className=" px-4 py-4 text-xl font-bold tracking-tight text-foreground transition-colors hover:bg-muted"
              >
                {label}
              </Link>
            ))}
          ...
          <div className="border-t border-border/40 p-4">
            ...
            >
              <Link href={APP_LOGIN_URL} onClick={closeMenu}>
                Log in
              </Link>
            </Button>
            <Button
            ...
            >
              <Link href={APP_SIGNUP_URL} onClick={closeMenu}>
                Sign up
              </Link>
            </Button>
          </div>
